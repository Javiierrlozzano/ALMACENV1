 ...
 * @author JAVIER
 */
public class FAMILIA1_1 extends javax.swing.JInternalFrame {

    /**
     * Creates new form Estadisticas1
     */
    public FAMILIA1_1(MySQL_Query Querys, boolean Activo) {
        initComponents();
        QueryFamilia1 =Querys;
        inic= Activo;
        IniciarData();
    ...
    private void initComponents() {
        ...
        Panel_Ganancias.add(btModificar, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 350, 130, 60));
        ...
        Panel_Ganancias.add(Descripcion, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 70, 130, 30));
        Panel_Ganancias.add(jSeparator6, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 50, 90, 20));

        jLabel13.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel13.setForeground(new java.awt.Color(255, 255, 255));
        jLabel13.setText("Descripción");
        Panel_Ganancias.add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 30, -1, -1));
        ...
        Home.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 20, 70, 50));
   ...
   // jButton3.setEnabled(x);
    ...
    public  void IniciarData() {
        try {
                String[] Colum = {"idFamilia1","descripcion","estado"}; 
               
                general.AgregarTableAPI(jTable1, Colum,  QueryFamilia1.GETAPI("/familia1/all"));
                activa(inic);
        } catch (Exception e) {
    ...
    private void btGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btGuardarActionPerformed
        try{
             ...
             GetTEXT();
               QueryFamilia1.POSTAPI("/familia1/save",JSonUnidad);
...
//            Logger.getLogger(UNDMEDIDA.class.getName()).log(Level.SEVERE, null, ex);
    ...
    String descripcion ;
    String estado  ;
    private MySQL_Query QueryFamilia1;
