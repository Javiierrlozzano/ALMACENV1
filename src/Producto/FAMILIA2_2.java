 ...
 * @author JAVIER
 */
public class FAMILIA2_2 extends javax.swing.JInternalFrame {

    /**
     * Creates new form Estadisticas1
     */
    public FAMILIA2_2(MySQL_Query Querys, boolean Activo) {
        initComponents();
        QuerysUnidad =Querys;
        inic= Activo;
        IniciarData();
    ...
    private void initComponents() {
        ...
        Panel_Ganancias.add(btAdicionar, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 400, 120, 60));
        ...
        Panel_Ganancias.add(btModificar, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 400, 130, 60));
        ...
        Panel_Ganancias.add(btGuardar, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 400, 110, 60));
        ...
        Panel_Ganancias.add(EstadoPro, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 70, 120, 30));
        ...
        Panel_Ganancias.add(jSeparator8, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 50, 90, 20));
        ...
        Panel_Ganancias.add(TIPO, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 70, 120, 30));
        Panel_Ganancias.add(jSeparator9, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 50, 90, 20));

        jLabel16.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel16.setForeground(new java.awt.Color(255, 255, 255));
        jLabel16.setText("Estados");
        Panel_Ganancias.add(jLabel16, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 30, -1, -1));
        ...
        Home.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 20, 90, 50));
   ...
   // EstadoPro.setSelectedItem(.setEnabled(x);
    ...
    public  void IniciarData() {
        try {
                String[] Colum = {"descripcion","idFamilia1"}; 
                 Dictionary<String,String> obj = general.DiccionarioAPI( Colum, QuerysUnidad.GETAPI("/familia1/all"));
    ...
    private void GetTEXT(){
         Id =idEstado.getText();
        if (Id.length() !=0 ) {
            valor=TIPO.getSelectedItem().toString();
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        TIPO.setSelectedItem(DatosTable[2]);
